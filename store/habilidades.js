export const state = () => ({
  habilidades: {
    tecnologias: [
      ...
      {
        id: '12T',
        src: require('~/assets/img/bootstrap-icon.svg'),
        title: 'Bootstrap',
      },
      {
        id: '13T',
        src: require('~/assets/img/icons-buefy.svg'),
        title: 'Buefy',
      },
      {
        id: '14T',
      ...
      {
        id: '15T',
        src: require('~/assets/img/icons-cypress.svg'),
        title: 'Cypress',
      },
      {
        id: '16 - T',
    ...
    workflow: [
      ...
      { id: '03W', info: '+ Desenvolvimento Ágil e Scrum' },
      { id: '04W', info: '+ Ingles intermediário' },
    ],
  },
})
